(function webpackUniversalModuleDefinition(root, factory) {
  ...
  else if (typeof exports === "object") exports["binary-live-api"] = factory();
  else root["binary-live-api"] = factory();
})(this, function () {
  return (function (modules) {
    ...
    function (module, exports, __webpack_require__) {
      ...
      var _dateAsLocalISOString2 = _interopRequireDefault(
        _dateAsLocalISOString
      );
    ...
    function (module, exports, __webpack_require__) {
      ...
      exports.default = function (duration, unit) {
        switch (unit) {
          ...
          default:
            throw new Error(
              "Duration unit not valid: " +
                unit +
                ", only allow ['t', 's', 'm', 'h', 'd']"
            );
        }
      };
    },
    ...
    function (module, exports, __webpack_require__) {
      ...
      exports.default = function (contract, lastTickQuote) {
        ...
        if (
          typeof contract.entry_spot === "undefined" &&
          typeof lastTickQuote === "undefined"
        ) {
    ...
    function (module, exports, __webpack_require__) {
      ...
      var _extractMinMaxInUnits2 = _interopRequireDefault(
        _extractMinMaxInUnits
      );
      function _interopRequireDefault(obj) {
        return obj && obj.__esModule ? obj : { default: obj };
      }
      exports.default = function (contracts, type) {
        ...
        var tickDuration =
          tickContracts.length > 0 ? { min: 5, max: 10, unit: "t" } : undefined;
        ...
        var nonTickMinSec = nonTickContracts
          .map(function (c) {
        ...
        var nonTickMaxSec = nonTickContracts
          .map(function (c) {
        ...
        var nonTicksDuration = (0, _extractMinMaxInUnits2.default)(
          nonTickMinSec,
          nonTickMaxSec
        );
        if (tickDuration) {
      ...
      exports.default = function (arr1, arr2) {
        ...
        switch (lengthDiff) {
          case 0:
            ...
            return (
              eq(arr1[arr1.length - 1], arr2[arr2.length - 2]) ||
    ...
    function (module, exports, __webpack_require__) {
      ...
      var LiveEvents = (function () {
        ...
        LiveEvents.prototype.emitSingle = function emitSingle(
          msgType,
          msgData
        ) {
    ...
    function (module, exports, __webpack_require__) {
      ...
      var autoAdjustGetData = (exports.autoAdjustGetData =
        function autoAdjustGetData(api, symbol, start, end) {
          var style =
          ...
          if (ticksCount >= responseSizeLimit || style === "candles") {
            ...
            granularities.forEach(function (g, i) {
              if (
                idealGranularity > g &&
                idealGranularity <= granularities[i + 1]
              ) {
          ...
          return api
            ...
            .then(function (r) {
              ...
              return _extends({}, extra, { ticks: ticks, symbol: symbol });
            });
        });
      ...
      function getDataForContract(api, getContract, duration) {
        ...
        var getAllData = function getAllData() {
          return getContract().then(function (contract) {
            ...
            var _computeStartEndForCo = (0,
              _binaryUtils.computeStartEndForContract)(contract),
        ...
        return getContract().then(function (contract) {
          ...
          if (startTime > (0, _binaryUtils.nowAsEpoch)()) {
            return autoAdjustGetData(
              api,
              symbol,
              (0, _binaryUtils.nowAsEpoch)() - 600,
              (0, _binaryUtils.nowAsEpoch)(),
              style,
              subscribe,
              { isSold: !!contract.sell_time }
            );
    ...
    function (module, exports, __webpack_require__) {
      ...
      var _commonRelativeBarrier2 = _interopRequireDefault(
        _commonRelativeBarrier
      );
      function _interopRequireDefault(obj) {
        return obj && obj.__esModule ? obj : { default: obj };
      }
      exports.default = function (contract, lastTickQuote) {
        return (0, _commonRelativeBarrier2.default)(
          contract.barrier,
          contract.entry_spot,
          lastTickQuote
        );
      ...
      exports.default = function (minInSecs, maxInSecs) {
        ...
        for (var i = 0; i < minInUnits.length; i++) {
          ...
          if (blockIsValid(minI, maxI, unit)) {
            durations.push({ unit: unit, min: minI > 0 ? minI : 1, max: maxI });
          }
        }
        return durations;
      };
    ...
    function (module, exports, __webpack_require__) {
      ...
      Object.defineProperty(exports, "getAbsoluteBarrierFromContract", {
        enumerable: true,
        get: function get() {
          return _interopRequireDefault(_getAbsoluteBarrierFromContract)
            .default;
        },
      });
      ...
      Object.defineProperty(exports, "extractForwardStartingDuration", {
        enumerable: true,
        get: function get() {
          return _interopRequireDefault(_extractForwardStartingDuration)
            .default;
        },
      });
      var _extractMinMaxInUnits = __webpack_require__(23);
    ...
    function (module, exports, __webpack_require__) {
      ...
      exports.default = function (ohlc1, ohlc2) {
        return (
          ...
          (!!ohlc1 &&
            !!ohlc2 &&
            ohlc1.epoch === ohlc2.epoch &&
            ohlc1.close === ohlc2.close)
        );
      };
    },
    function (module, exports, __webpack_require__) {
      ...
      exports.default = function (tick1, tick2) {
        return (
          ...
          (!!tick1 &&
            !!tick2 &&
            tick1.epoch === tick2.epoch &&
            tick1.quote === tick2.quote)
        );
      };
    },
    function (module, exports, __webpack_require__) {
    ...
    function (module, exports, __webpack_require__) {
      ...
      var ApiState = function ApiState() {
        ...
        this.subscribeToPriceForContractProposal = function (
          options,
          streamId
        ) {
          if (streamId) {
    ...
    function (module, exports, __webpack_require__) {
      ...
      var LiveApi = (function () {
        function LiveApi(initParams) {
          ...
          this.resubscriptions = {
            ...
            unauthorized: {
              tick: function tick() {
                ...
                _this
                  .getInState("ticksHistory")
                  .forEach(function (param, symbol) {
                    return _this.getTickHistory(symbol, param);
                  });
              },
              ohlc: function ohlc() {
                _this
                  .getInState("candlesHistory")
                  .forEach(function (param, symbol) {
                    return _this.getTickHistory(symbol, param);
                  });
              },
          ...
          this.generatePromiseOrObservable = function (json) {
            ...
            return new Promise(function (resolve, reject) {
              _this.unresolvedPromises[reqId] = {
                resolve: resolve,
                reject: reject,
              };
            });
          ...
          this.sendAndUpdateState = function (callName) {
            ...
            var json = _extends({ req_id: reqId }, actualPaylod);
            ...
            if (typeof json.req_id !== "undefined") {
              var setState = function setState(r) {
                ...
                if (r.proposal_open_contract && r.proposal_open_contract.id) {
                  var _apiState2;
                  (_apiState2 = _this.apiState)[callName].apply(
                    _apiState2,
                    param.concat([r.proposal_open_contract.id])
                  );
                } else if (r.proposal && r.proposal.id) {
                  var _apiState3;
                  (_apiState3 = _this.apiState)[callName].apply(
                    _apiState3,
                    param.concat([r.proposal.id])
                  );
                }
                return r;
              };
          ...
          this.send = function (json) {
            console.warn("This method is deprecated, use high-level methods");
            var reqId = (0, _binaryUtils.getUniqueId)();
            return _this.sendRaw(_extends({ req_id: reqId }, json));
          };
          ...
          var _ref = initParams || {},
            ...
            sendSpy =
              _ref$sendSpy === undefined ? function () {} : _ref$sendSpy,
        ...
        LiveApi.prototype.bindCallsAndStateMutators =
          function bindCallsAndStateMutators() {
            var _this2 = this;
            Object.keys(calls).forEach(function (callName) {
              _this2[callName] = function () {
                ...
                return _this2.sendAndUpdateState.apply(
                  _this2,
                  [callName].concat(params)
                );
              };
            });
            Object.keys(customCalls).forEach(function (callName) {
              _this2[callName] = function () {
                ...
                return customCalls[callName].apply(
                  customCalls,
                  [_this2].concat(params)
                );
              };
            });
          };
        LiveApi.prototype.connect = function connect(connection) {
          ...
          Object.keys(this.unresolvedPromises).forEach(function (reqId) {
            var disconnectedError = new Error(
              "Websocket disconnected before response received."
            );
    ...
    function (module, exports, __webpack_require__) {
      ...
      var oauthUrlWithLanguage = (exports.oauthUrlWithLanguage =
        function oauthUrlWithLanguage(appId, langCode) {
          return (
            "https://www.binary.com/oauth2/authorize?app_id=" +
            appId +
            "&l=" +
            langCode
          );
        });
      var parseOAuthResponse = (exports.parseOAuthResponse =
        function parseOAuthResponse(responseUrl) {
          ...
          for (var i = 1; i < params.length; i += 3) {
            accounts.push({ account: params[i], token: params[i + 1] });
          }
          return accounts;
        });
    },
    ...
    function (module, exports, __webpack_require__) {
      ...
      var deleteApiToken = (exports.deleteApiToken = function deleteApiToken(
        token
      ) {
        return { api_token: 1, delete_token: token };
      });
      var getApiTokens = (exports.getApiTokens = function getApiTokens() {
        return { api_token: 1 };
      });
      var createApiToken = (exports.createApiToken = function createApiToken(
        token,
        scopes
      ) {
        return { api_token: 1, new_token: token, new_token_scopes: scopes };
      });
      ...
      var registerApplication = (exports.registerApplication =
        function registerApplication(options) {
          return _extends({ app_register: 1 }, options);
        });
      var getAllAppList = (exports.getAllAppList = function getAllAppList() {
        return { app_list: 1 };
      });
      var getAppslistById = (exports.getAppslistById = function getAppslistById(
        appid
      ) {
        return { app_get: appid };
      });
      var deleteApplication = (exports.deleteApplication =
        function deleteApplication(appid) {
          return { app_delete: appid };
        });
      var createRealAccountMaltaInvest = (exports.createRealAccountMaltaInvest =
        function createRealAccountMaltaInvest(options) {
          return _extends({ new_account_maltainvest: 1 }, options);
        });
      var createRealAccount = (exports.createRealAccount =
        function createRealAccount(options) {
          return _extends({ new_account_real: 1 }, options);
        });
      var setAccountCurrency = (exports.setAccountCurrency =
        function setAccountCurrency(currency) {
          return { set_account_currency: currency };
        });
      var setSelfExclusion = (exports.setSelfExclusion =
        function setSelfExclusion(options) {
          return _extends({ set_self_exclusion: 1 }, options);
        });
      var setAccountSettings = (exports.setAccountSettings =
        function setAccountSettings(options) {
          return _extends({ set_settings: 1 }, options);
        });
      var setTnCApproval = (exports.setTnCApproval = function setTnCApproval() {
        return { tnc_approval: 1 };
      });
    },
    function (module, exports, __webpack_require__) {
      "use strict";
    ...
    function (module, exports, __webpack_require__) {
      ...
      var getCashierLockStatus = (exports.getCashierLockStatus =
        function getCashierLockStatus() {
          return { cashier_password: 1 };
        });
      var setCashierLock = (exports.setCashierLock = function setCashierLock(
        options
      ) {
        return _extends({ cashier_password: 1 }, options);
      });
      var withdrawToPaymentAgent = (exports.withdrawToPaymentAgent =
        function withdrawToPaymentAgent(options) {
          return _extends({ paymentagent_withdraw: 1 }, options);
        });
      var paymentAgentTransfer = (exports.paymentAgentTransfer =
        function paymentAgentTransfer(options) {
          return _extends({ paymentagent_transfer: 1 }, options);
        });
      var transferBetweenAccounts = (exports.transferBetweenAccounts =
        function transferBetweenAccounts(options) {
          return _extends({ transfer_between_accounts: 1 }, options);
        });
    },
    function (module, exports, __webpack_require__) {
      "use strict";
      ...
      var getAccountLimits = (exports.getAccountLimits =
        function getAccountLimits() {
          return { get_limits: 1 };
        });
      var getAccountSettings = (exports.getAccountSettings =
        function getAccountSettings() {
          return { get_settings: 1 };
        });
      var getAccountStatus = (exports.getAccountStatus =
        function getAccountStatus() {
          return { get_account_status: 1 };
        });
      var getSelfExclusion = (exports.getSelfExclusion =
        function getSelfExclusion() {
          return { get_self_exclusion: 1 };
        });
      var logOut = (exports.logOut = function logOut() {
        return { logout: 1 };
      });
      var getStatement = (exports.getStatement = function getStatement(
        options
      ) {
        return _extends({ statement: 1 }, options);
      });
      var getPortfolio = (exports.getPortfolio = function getPortfolio() {
        return { portfolio: 1 };
      });
      var getProfitTable = (exports.getProfitTable = function getProfitTable(
        options
      ) {
        return _extends({ profit_table: 1 }, options);
      });
      var getRealityCheckSummary = (exports.getRealityCheckSummary =
        function getRealityCheckSummary() {
          return { reality_check: 1 };
        });
      var subscribeToBalance = (exports.subscribeToBalance =
        function subscribeToBalance() {
          return { balance: 1, subscribe: 1 };
        });
      var unsubscribeFromBalance = (exports.unsubscribeFromBalance =
        function unsubscribeFromBalance() {
          return { forget_all: "balance" };
        });
      var subscribeToOpenContract = (exports.subscribeToOpenContract =
      ...
      var getContractInfo = (exports.getContractInfo = function getContractInfo(
        contractId
      ) {
        return { proposal_open_contract: 1, contract_id: contractId };
      });
      var subscribeToAllOpenContracts = (exports.subscribeToAllOpenContracts =
        function subscribeToAllOpenContracts() {
          return { proposal_open_contract: 1, subscribe: 1 };
        });
      var unsubscribeFromAllOpenContracts =
        (exports.unsubscribeFromAllOpenContracts =
          function unsubscribeFromAllOpenContracts() {
            return { forget_all: "proposal_open_contract" };
          });
      var subscribeToTransactions = (exports.subscribeToTransactions =
        function subscribeToTransactions() {
          return { transaction: 1, subscribe: 1 };
        });
      var unsubscribeFromTransactions = (exports.unsubscribeFromTransactions =
        function unsubscribeFromTransactions() {
          return { forget_all: "transaction" };
        });
    },
    function (module, exports, __webpack_require__) {
      "use strict";
      exports.__esModule = true;
      var buyContract = (exports.buyContract = function buyContract(
        contractId,
        price
      ) {
        return { buy: contractId, price: price };
      });
      var buyContractParams = (exports.buyContractParams =
        function buyContractParams(params, price) {
          return { buy: 1, price: price, parameters: params };
        });
      var sellContract = (exports.sellContract = function sellContract(
        contractId,
        price
      ) {
        return { sell: contractId, price: price };
      });
      var sellExpiredContracts = (exports.sellExpiredContracts =
        function sellExpiredContracts() {
          return { sell_expired: 1 };
        });
      var topUpVirtualAccount = (exports.topUpVirtualAccount =
        function topUpVirtualAccount() {
          return { topup_virtual: 1 };
        });
    },
    function (module, exports, __webpack_require__) {
      "use strict";
      ...
      var getActiveSymbolsBrief = (exports.getActiveSymbolsBrief =
        function getActiveSymbolsBrief() {
          return { active_symbols: "brief" };
        });
      var getActiveSymbolsFull = (exports.getActiveSymbolsFull =
        function getActiveSymbolsFull() {
          return { active_symbols: "full" };
        });
      ...
      var getContractsForSymbol = (exports.getContractsForSymbol =
        function getContractsForSymbol(symbol) {
          return { contracts_for: symbol };
        });
      var unsubscribeFromTick = (exports.unsubscribeFromTick =
        function unsubscribeFromTick(symbol) {
          return { forget: symbol };
        });
      var unsubscribeFromTicks = (exports.unsubscribeFromTicks =
        function unsubscribeFromTicks(symbols) {
          return { forget: symbols };
        });
      var unsubscribeByID = (exports.unsubscribeByID = function unsubscribeByID(
        id
      ) {
        return { forget: id };
      });
      var unsubscribeFromAllTicks = (exports.unsubscribeFromAllTicks =
        function unsubscribeFromAllTicks() {
          return { forget_all: "ticks" };
        });
      var unsubscribeFromAllCandles = (exports.unsubscribeFromAllCandles =
        function unsubscribeFromAllCandles() {
          return { forget_all: "candles" };
        });
      var unsubscribeFromAllProposals = (exports.unsubscribeFromAllProposals =
        function unsubscribeFromAllProposals() {
          return { forget_all: "proposal" };
        });
      var unsubscribeFromAllPortfolios = (exports.unsubscribeFromAllPortfolios =
        function unsubscribeFromAllPortfolios() {
          return { forget_all: "portfolio" };
        });
      var getLandingCompany = (exports.getLandingCompany =
        function getLandingCompany(landingCompany) {
          return { landing_company: landingCompany };
        });
      var getLandingCompanyDetails = (exports.getLandingCompanyDetails =
        function getLandingCompanyDetails(landingCompany) {
          return { landing_company_details: landingCompany };
        });
      var createVirtualAccount = (exports.createVirtualAccount =
        function createVirtualAccount(options) {
          return _extends({ new_account_virtual: 1 }, options);
        });
      var ping = (exports.ping = function ping() {
        return { ping: 1 };
      });
      var getPaymentAgentsForCountry = (exports.getPaymentAgentsForCountry =
        function getPaymentAgentsForCountry(countryCode) {
          return { paymentagent_list: countryCode };
        });
      var getPayoutCurrencies = (exports.getPayoutCurrencies =
        function getPayoutCurrencies() {
          return { payout_currencies: 1 };
        });
      var getPriceProposalForContract = (exports.getPriceProposalForContract =
        function getPriceProposalForContract(options) {
          return _extends({ proposal: 1 }, options);
        });
      var subscribeToPriceForContractProposal =
        (exports.subscribeToPriceForContractProposal =
          function subscribeToPriceForContractProposal(options) {
            return _extends({ proposal: 1, subscribe: 1 }, options);
          });
      var getResidences = (exports.getResidences = function getResidences() {
        return { residence_list: 1 };
      });
      var getStatesForCountry = (exports.getStatesForCountry =
        function getStatesForCountry(countryCode) {
          return { states_list: countryCode };
        });
      var subscribeToTick = (exports.subscribeToTick = function subscribeToTick(
        symbol
      ) {
        return { ticks: symbol };
      });
      var subscribeToTicks = (exports.subscribeToTicks =
        function subscribeToTicks(symbols) {
          return { ticks: symbols };
        });
      var getTickHistory = (exports.getTickHistory = function getTickHistory(
        symbol,
        options
      ) {
        return _extends(
      ...
      var getCandles = (exports.getCandles = function getCandles(
        symbol,
        options
      ) {
        return _extends(
      ...
      var getCandlesForLastNDays = (exports.getCandlesForLastNDays =
        function getCandlesForLastNDays(symbol, ndays) {
          return {
            ticks_history: symbol,
            style: "candles",
      ...
      var getTradingTimes = (exports.getTradingTimes = function getTradingTimes(
        date
      ) {
        return {
          trading_times:
      ...
      var verifyEmail = (exports.verifyEmail = function verifyEmail(
        email,
        type
      ) {
        return { verify_email: email, type: type };
      });
      var getWebsiteStatus = (exports.getWebsiteStatus =
    ...
    function (module, exports, __webpack_require__) {
      ...
      Object.defineProperty(exports, "__esModule", { value: true });
      var _getAbsoluteBarrierFromContract = __webpack_require__(7);
      var _getAbsoluteBarrierFromContract2 = _interopRequireDefault(
        _getAbsoluteBarrierFromContract
      );
      function _interopRequireDefault(obj) {
        return obj && obj.__esModule ? obj : { default: obj };
      }
      exports.default = function (contract, lastTickQuote) {
        return (0, _getAbsoluteBarrierFromContract2.default)(
          contract,
          lastTickQuote,
          "barrier2"
        );
    ...
    function (module, exports, __webpack_require__) {
      ...
      exports.default = function (contract, lastTickQuote) {
        return contract.barrier
          ? (0, _relativeBarrier2.default)(contract, lastTickQuote)
    ...
    function (module, exports, __webpack_require__) {
      ...
      var extractDigitBarrierHelper = function extractDigitBarrierHelper(
        contractsGroupedByExpiry
      ) {
      ...
      var extract2BarriersHelper = function extract2BarriersHelper(
        contractsGroupedByExpiry
      ) {
        var expiryTypes = Object.keys(contractsGroupedByExpiry);
        var result = {};
        expiryTypes.forEach(function (et) {
          ...
          result[et] = [
            {
              name: "High barrier",
              defaultValue: contractsByExpiry[0].high_barrier,
            },
            {
              name: "Low barrier",
              defaultValue: contractsByExpiry[0].low_barrier,
            },
          ];
        });
        return result;
      };
      var extract1BarrierHelper = function extract1BarrierHelper(
        contractGroupedByExpiry,
        barrierName
      ) {
        ...
        expiryTypes.forEach(function (et) {
          ...
          result[et] = [
            { name: barrierName, defaultValue: contractWithBarrier.barrier },
          ];
        });
        return result;
      };
      exports.default = function (contracts, type) {
        var groupByExpiryType = (0, _groupByKey2.default)(
          contracts,
          "expiry_type"
        );
        switch (type) {
    ...
    function (module, exports, __webpack_require__) {
      ...
      exports.default = function () {
        ...
        return (0, _dateToDateString2.default)(
          (0, _epochToDate2.default)(epoch)
        );
      };
    },
    function (module, exports, __webpack_require__) {
    ...
    function (module, exports, __webpack_require__) {
      ...
      exports.default = function (loginTime, interval) {
        return (
          interval - (((0, _nowAsEpoch2.default)() - loginTime) % interval)
        );
      };
    },
    function (module, exports, __webpack_require__) {
      ...
      exports.default = function (start, end, target) {
        if ((0, _timeStringBigger2.default)(end, start)) {
          return (
            (0, _timeStringBigger2.default)(target, start) &&
            (0, _timeStringSmaller2.default)(target, end)
          );
        }
        return !(
          (0, _timeStringBigger2.default)(target, end) &&
          (0, _timeStringSmaller2.default)(target, start)
        );
      };
    },
    function (module, exports, __webpack_require__) {
      ...
      exports.default = function (timeString) {
        ...
        if (tokens.length !== 2) {
          throw new Error(
            "Time string format incorrect, expecting HH:mm, actual: " +
              timeString
          );
        }
        var h = +tokens[0];
    ...
    function (module, exports, __webpack_require__) {
      ...
      exports.default = function () {
        return (0, _dateToDateString2.default)(
          new Date((0, _yesterdayEpoch2.default)() * 1000)
        );
      };
    },
    function (module, exports, __webpack_require__) {
      ...
      exports.default = function () {
        return new Date((0, _yesterdayEpoch2.default)() * 1000)
          .toISOString()
          .slice(0, 10);
      };
    },
    ...
    function (module, exports, __webpack_require__) {
      ...
      Object.defineProperty(exports, "__esModule", { value: true });
      var _extractDurationHelper = __webpack_require__(12);
      var _extractDurationHelper2 = _interopRequireDefault(
        _extractDurationHelper
      );
      function _interopRequireDefault(obj) {
        return obj && obj.__esModule ? obj : { default: obj };
      }
      exports.default = function (contracts, type) {
        ...
        return (0, _extractDurationHelper2.default)(
          nonForwardStartingContracts,
          type
        );
      };
    },
    function (module, exports, __webpack_require__) {
      ...
      exports.default = function (contracts, type) {
        ...
        var forwardOptions =
          forwardStartingContracts[0].forward_starting_options;
        var groupByDate = (0, _groupByKey2.default)(
          forwardOptions || [],
          "date"
        );
        ...
        Object.keys(groupByDate)
          ...
          .forEach(function (date) {
            ...
            forwardStartingRange.push(
              _extends({ date: new Date(date * 1000) }, timesPerDateObj)
            );
          });
        var forwardStartingDurations = (0, _extractDurationHelper2.default)(
          forwardStartingContracts,
          type
        );
        return {
    ...
    function (module, exports, __webpack_require__) {
      ...
      exports.default = function (duration, durationUnit) {
        return (
          (0, _isDurationTick2.default)(durationUnit) ||
          (0, _durationToSecs2.default)(duration, durationUnit) < 120
        );
      };
    },
    function (module, exports, __webpack_require__) {
    ...
    function (module, exports, __webpack_require__) {
      ...
      var trackUserId = (exports.trackUserId = function trackUserId(
        userId,
        ga
      ) {
    ...
    function (module, exports, __webpack_require__) {
      ...
      exports.default = function (value) {
        return (
          (value < 0 && "number-negative") ||
          (value > 0 && "number-positive") ||
          ""
        );
      };
    },
    ...
    function (module, exports, __webpack_require__) {
      ...
      exports.default = function () {
        return (
          ...
          (isMobileBrowser() || !!window.cordova)
        );
      };
    },
    function (module, exports, __webpack_require__) {
    ...
    function (module, exports, __webpack_require__) {
      ...
      exports.default = function (ticks1, ticks2) {
        return (
          ...
          (ticks1.length === 0 ||
            ticks1[ticks1.length - 1].epoch === ticks2[ticks2.length - 1].epoch)
        );
      };
    },
    function (module, exports, __webpack_require__) {
      ...
      var _doArrayDifferJustOneEntry = __webpack_require__(13);
      var _doArrayDifferJustOneEntry2 = _interopRequireDefault(
        _doArrayDifferJustOneEntry
      );
      function _interopRequireDefault(obj) {
        return obj && obj.__esModule ? obj : { default: obj };
      }
      exports.default = function (candles1, candles2) {
        return (0, _doArrayDifferJustOneEntry2.default)(
          candles1,
          candles2,
          _doCandleEqual2.default
        );
      };
    },
    function (module, exports, __webpack_require__) {
    ...
    function (module, exports, __webpack_require__) {
      ...
      exports.default = function (history) {
        return history.times.map(function (t, idx) {
          return { epoch: +t, quote: +history.prices[idx] };
        });
      };
    },
    function (module, exports, __webpack_require__) {
      ...
      exports.default = function (contract) {
        ...
        if (contractEnd <= contractStart) {
          var e = new RangeError(
            "Contract ends time is earlier than start time"
          );
        ...
        return { end: Math.round(end), start: Math.round(start) };
      };
    },
    function (module, exports, __webpack_require__) {
      "use strict";
    ...
    function (module, exports, __webpack_require__) {
      ...
      exports.default = function (contracts) {
        ...
        var groupByCategory = (0, _groupByKey2.default)(
          extraRemoved,
          "contract_category"
        );
        ...
        allCategory.forEach(function (c) {
          ...
          var groupByType = (0, _groupByKey2.default)(
            relatedContracts,
            "contract_type"
          );
    ...
    function (module, exports, __webpack_require__) {
      ...
      exports.default = function (code, barrier) {
        return (
          (0, _tradeTypeCodeToText2.default)(code) +
          ((0, _typeHasBarrier2.default)(code) ? " " + barrier : "")
        );
      };
    },
    function (module, exports, __webpack_require__) {
      ...
      (function (module, global, process) {
        ...
        (function (undefined) {
          ...
          var noop = (Rx.helpers.noop = function () {}),
            ...
            defaultSubComparer = (Rx.helpers.defaultSubComparer = function (
              x,
              y
            ) {
              return x > y ? 1 : x < y ? -1 : 0;
            }),
            defaultKeySerializer = (Rx.helpers.defaultKeySerializer = function (
              x
            ) {
              return x.toString();
            }),
          ...
          var ArgumentOutOfRangeError = (Rx.ArgumentOutOfRangeError =
            function () {
          ...
          var NotImplementedError = (Rx.NotImplementedError = function (
            message
          ) {
          ...
          var bindCallback = (Rx.internals.bindCallback = function (
            func,
            thisArg,
            argCount
          ) {
          ...
          function equalObjects(
            ...
            while (++index < objLength) {
              ...
              if (
                !(result === undefined
                  ? equalFunc(objValue, othValue, isLoose, stackA, stackB)
                  : result)
              ) {
                return false;
              }
              ...
              if (isLoose) {
                if (
                  !arraySome(other, function (othValue) {
                    return (
                      arrValue === othValue ||
                      equalFunc(arrValue, othValue, isLoose, stackA, stackB)
                    );
                  })
                ) {
                  return false;
          ...
          var addProperties = (Rx.internals.addProperties = function (obj) {
            for (
              var sources = [], i = 1, len = arguments.length;
              i < len;
              i++
            ) {
          ...
          var checkDisposed = (Disposable.checkDisposed = function (
            disposable
          ) {
          ...
          SingleAssignmentDisposable.prototype.setDisposable = function (
            value
          ) {
            if (this.current) {
          ...
          var BinaryDisposable = (Rx.BinaryDisposable = function (
            first,
            second
          ) {
            this._first = first;
          ...
          var RefCountDisposable = (Rx.RefCountDisposable = (function () {
            ...
            RefCountDisposable.prototype.getDisposable = function () {
              return this.isDisposed
                ? disposableEmpty
                : new InnerDisposable(this);
            };
            return RefCountDisposable;
          })());
          var ScheduledItem = (Rx.internals.ScheduledItem = function (
            scheduler,
            state,
            action,
            dueTime,
          ...
          (function (schedulerProto) {
            ...
            function invokeRecDate(scheduler, pair) {
              ...
              function innerAction(state2, dueTime1) {
                var isAdded = false,
                  isDone = false;
                var d = scheduler.scheduleFuture(
                  state2,
                  dueTime1,
                  scheduleWork
                );
            ...
            schedulerProto.scheduleRecursiveFuture = function (
              state,
              dueTime,
              action
            ) {
          ...
          var immediateScheduler = (Scheduler.immediate =
          ...
          var CurrentThreadScheduler = (function (__super__) {
            ...
            CurrentThreadScheduler.prototype.schedule = function (
              state,
              action
            ) {
          ...
          var SchedulePeriodicRecursive =
            (Rx.internals.SchedulePeriodicRecursive = (function () {
              ...
              function SchedulePeriodicRecursive(
                scheduler,
                state,
                period,
                action
          ...
          (function () {
            ...
            var setImmediate =
              typeof (setImmediate =
                freeGlobal && moduleExports && freeGlobal.setImmediate) ==
                "function" &&
              !reNative.test(setImmediate) &&
              setImmediate;
            ...
            if (isFunction(setImmediate)) {
              ...
              "document" in root &&
              "onreadystatechange" in root.document.createElement("script")
            ) {
              scheduleMethod = function (action) {
          ...
          var DefaultScheduler = (function (__super__) {
            ...
            function scheduleAction(disposable, action, scheduler, state) {
              return function schedule() {
                disposable.setDisposable(
                  Disposable._fixup(action(scheduler, state))
                );
              };
            }
            ...
            DefaultScheduler.prototype.schedule = function (state, action) {
              var disposable = new SingleAssignmentDisposable(),
                id = scheduleMethod(
                  scheduleAction(disposable, action, this, state)
                );
              return new BinaryDisposable(disposable, new ClearDisposable(id));
            };
            DefaultScheduler.prototype._scheduleFuture = function (
              state,
              dueTime,
              action
            ) {
          ...
          var PriorityQueue = (Rx.internals.PriorityQueue = function (
            capacity
          ) {
          ...
          var Notification = (Rx.Notification = (function () {
            ...
            Notification.prototype._accept = function (
              onNext,
              onError,
              onCompleted
            ) {
            ...
            Notification.prototype._acceptObserver = function (
              onNext,
              onError,
              onCompleted
            ) {
          ...
          var OnCompletedNotification = (function (__super__) {
            ...
            OnCompletedNotification.prototype._accept = function (
              onNext,
              onError,
              onCompleted
            ) {
          ...
          var notificationCreateOnError = (Notification.createOnError =
            function (error) {
              return new OnErrorNotification(error);
            });
          var notificationCreateOnCompleted = (Notification.createOnCompleted =
            function () {
              return new OnCompletedNotification();
            });
          var Observer = (Rx.Observer = function () {});
          var observerCreate = (Observer.create = function (
            onNext,
            onError,
            onCompleted
          ) {
          ...
          var AbstractObserver = (Rx.internals.AbstractObserver = (function (
            __super__
          ) {
          ...
          var Observable = (Rx.Observable = (function () {
            ...
            observableProto.subscribe = observableProto.forEach = function (
              oOrOnNext,
              onError,
              onCompleted
            ) {
              return this._subscribe(
                typeof oOrOnNext === "object"
                  ? oOrOnNext
            ...
            observableProto.subscribeOnCompleted = function (
              onCompleted,
              thisArg
            ) {
              return this._subscribe(
            ...
            ScheduledObserver.prototype.ensureActive = function () {
              ...
              isOwner &&
                this.disposable.setDisposable(
                  this.scheduler.scheduleRecursive(this, scheduleMethod)
                );
            };
          ...
          var ObservableBase = (Rx.ObservableBase = (function (__super__) {
            ...
            function fixSubscriber(subscriber) {
              return subscriber && isFunction(subscriber.dispose)
                ? subscriber
                : isFunction(subscriber)
          ...
          var FlatMapObservable = (Rx.FlatMapObservable = (function (
            __super__
          ) {
            ...
            FlatMapObservable.prototype.subscribeCore = function (o) {
              return this.source.subscribe(
                new InnerObserver(o, this.selector, this.resultSelector, this)
              );
            };
            ...
            InnerObserver.prototype.next = function (x) {
              ...
              (isArrayLike(result) || isIterable(result)) &&
          ...
          var ConcatEnumerableObservable = (function (__super__) {
            ...
            function scheduleMethod(state, recurse) {
              ...
              d.setDisposable(
                currentValue.subscribe(new InnerObserver(state, recurse))
              );
            }
            ConcatEnumerableObservable.prototype.subscribeCore = function (o) {
              ...
              var cancelable = currentThreadScheduler.scheduleRecursive(
                state,
                scheduleMethod
              );
          ...
          var enumerableRepeat = (Enumerable.repeat = function (
            value,
            repeatCount
          ) {
          ...
          var enumerableOf = (Enumerable.of = function (
            source,
            selector,
            thisArg
          ) {
          ...
          var observableDefer = (Observable.defer = function (
            observableFactory
          ) {
          ...
          var observableEmpty = (Observable.empty = function (scheduler) {
            isScheduler(scheduler) || (scheduler = immediateScheduler);
            return scheduler === immediateScheduler
              ? EMPTY_OBSERVABLE
              : new EmptyObservable(scheduler);
          });
          var FromObservable = (function (__super__) {
            ...
            FromObservable.prototype.subscribeCore = function (o) {
              ...
              return this._scheduler.scheduleRecursive(
                0,
                createScheduleMethod(o, it, this._fn)
              );
            };
          ...
          StringIterator.prototype.next = function () {
            return this._i < this._l
              ? { done: false, value: this._s.charAt(this._i++) }
              : doneEnumerator;
          };
          ...
          ArrayIterator.prototype.next = function () {
            return this._i < this._l
              ? { done: false, value: this._a[this._i++] }
              : doneEnumerator;
          };
          ...
          var observableFrom = (Observable.from = function (
            iterable,
            mapFn,
            thisArg,
            scheduler
          ...
          var FromArrayObservable = (function (__super__) {
            ...
            FromArrayObservable.prototype.subscribeCore = function (o) {
              return this._scheduler.scheduleRecursive(
                0,
                scheduleMethod(o, this._args)
              );
            };
            return FromArrayObservable;
          })(ObservableBase);
          var observableFromArray = (Observable.fromArray = function (
            array,
            scheduler
          ) {
            isScheduler(scheduler) || (scheduler = currentThreadScheduler);
          ...
          var PairsObservable = (function (__super__) {
            ...
            PairsObservable.prototype.subscribeCore = function (o) {
              return this._scheduler.scheduleRecursive(
                0,
                scheduleMethod(o, this._o, this._keys)
              );
            };
          ...
          var observableReturn =
            (Observable["return"] =
            Observable.just =
              function (value, scheduler) {
                isScheduler(scheduler) || (scheduler = immediateScheduler);
          ...
          var observableThrow = (Observable["throw"] = function (
            error,
            scheduler
          ) {
            isScheduler(scheduler) || (scheduler = immediateScheduler);
            ...
            CatchObservable.prototype.subscribeCore = function (o) {
              ...
              d1.setDisposable(
                this.source.subscribe(
                  new CatchObserver(o, subscription, this._fn)
                )
              );
              return subscription;
            };
          ...
          observableProto["catch"] = function (handlerOrSecond) {
            return isFunction(handlerOrSecond)
              ? new CatchObservable(this, handlerOrSecond)
          ...
          var CombineLatestObservable = (function (__super__) {
            ...
            CombineLatestObservable.prototype.subscribeCore = function (
              observer
            ) {
          ...
          var CombineLatestObserver = (function (__super__) {
            ...
            CombineLatestObserver.prototype.next = function (x) {
              ...
              if (
                ...
                this._state.isDone.filter(notTheSame(this._i)).every(identity)
              ) {
                this._o.onCompleted();
              }
            };
          ...
          var combineLatest = (Observable.combineLatest = function () {
            ...
            var resultSelector = isFunction(args[len - 1])
              ? args.pop()
              : argumentsToArray;
          ...
          var ConcatObservable = (function (__super__) {
            ...
            function scheduleRecursive(state, recurse) {
              ...
              state.subscription.setDisposable(d);
              d.setDisposable(
                currentValue.subscribe(new ConcatObserver(state, recurse))
              );
            }
            ConcatObservable.prototype.subscribeCore = function (o) {
              ...
              var cancelable = immediateScheduler.scheduleRecursive(
                state,
                scheduleRecursive
              );
          ...
          var MergeObservable = (function (__super__) {
            ...
            MergeObservable.prototype.subscribeCore = function (observer) {
              ...
              g.add(
                this.source.subscribe(
                  new MergeObserver(observer, this.maxConcurrent, g)
                )
              );
              return g;
            };
          ...
          var CompositeError = (Rx.CompositeError = function (errors) {
            ...
            this.message =
              "This contains multiple errors. Check the innerErrors";
            Error.call(this);
          });
          ...
          var MergeDelayErrorObservable = (function (__super__) {
            ...
            MergeDelayErrorObservable.prototype.subscribeCore = function (o) {
              ...
              group.add(m);
              m.setDisposable(
                this.source.subscribe(new MergeDelayErrorObserver(group, state))
              );
              return group;
            };
          ...
          var MergeDelayErrorObserver = (function (__super__) {
            ...
            MergeDelayErrorObserver.prototype.next = function (x) {
              ...
              inner.setDisposable(
                x.subscribe(new InnerObserver(inner, this._group, this._state))
              );
            };
            MergeDelayErrorObserver.prototype.error = function (e) {
              ...
              this._group.length === 1 &&
                setCompletion(this._state.o, this._state.errors);
            };
          ...
          var MergeAllObservable = (function (__super__) {
            ...
            MergeAllObservable.prototype.subscribeCore = function (o) {
              ...
              g.add(m);
              m.setDisposable(
                this.source.subscribe(new MergeAllObserver(o, g))
              );
              return g;
            };
          ...
          var MergeAllObserver = (function (__super__) {
            ...
            MergeAllObserver.prototype.next = function (innerSource) {
              var sad = new SingleAssignmentDisposable();
              this.g.add(sad);
              isPromise(innerSource) &&
                (innerSource = observableFromPromise(innerSource));
              sad.setDisposable(
                innerSource.subscribe(new InnerObserver(this, sad))
              );
            };
          ...
          var SkipUntilObservable = (function (__super__) {
            ...
            SkipUntilObservable.prototype.subscribeCore = function (o) {
              ...
              leftSubscription.setDisposable(
                this._s.subscribe(new SkipUntilSourceObserver(o, this))
              );
              isPromise(this._o) && (this._o = observableFromPromise(this._o));
              var rightSubscription = new SingleAssignmentDisposable();
              rightSubscription.setDisposable(
                this._o.subscribe(
                  new SkipUntilOtherObserver(o, this, rightSubscription)
                )
              );
          ...
          var SwitchObservable = (function (__super__) {
            ...
            SwitchObserver.prototype.next = function (innerSource) {
              ...
              isPromise(innerSource) &&
                (innerSource = observableFromPromise(innerSource));
              d.setDisposable(
                innerSource.subscribe(new InnerObserver(this, id))
              );
            };
          ...
          observableProto["switch"] = observableProto.switchLatest =
            function () {
          ...
          var TakeUntilObservable = (function (__super__) {
            ...
            function TakeUntilObservable(source, other) {
              this.source = source;
              this.other = isPromise(other)
                ? observableFromPromise(other)
                : other;
              __super__.call(this);
            }
          ...
          var WithLatestFromObservable = (function (__super__) {
            ...
            WithLatestFromObservable.prototype.subscribeCore = function (o) {
              ...
              for (var i = 0; i < n; i++) {
                ...
                sad.setDisposable(
                  other.subscribe(new WithLatestFromOtherObserver(o, i, state))
                );
                subscriptions[i] = sad;
              }
              var outerSad = new SingleAssignmentDisposable();
              outerSad.setDisposable(
                this._s.subscribe(
                  new WithLatestFromSourceObserver(o, this._cb, state)
                )
              );
          ...
          var ZipObservable = (function (__super__) {
            ...
            ZipObservable.prototype.subscribeCore = function (observer) {
              ...
              for (var i = 0; i < n; i++) {
                ...
                isPromise(source) && (source = observableFromPromise(source));
                sad.setDisposable(
                  source.subscribe(new ZipObserver(observer, i, this, q, done))
                );
              }
              return new NAryDisposable(subscriptions);
            };
            ...
            ZipIterableObservable.prototype.subscribeCore = function (o) {
              ...
              for (var i = 0; i < len; i++) {
                (function (i) {
                  ...
                  subscriptions[i] = sad;
                  sad.setDisposable(
                    source.subscribe(new ZipIterableObserver(state, i))
                  );
                })(i);
              }
              return new NAryDisposable(subscriptions);
          ...
          var ZipIterableObserver = (function (__super__) {
            ...
            ZipIterableObserver.prototype.next = function (x) {
              ...
              if (this._s.q.every(notEmpty)) {
                ...
                this._s.done.filter(notTheSame(this._i)).every(identity)
              ) {
          ...
          var DistinctUntilChangedObservable = (function (__super__) {
            ...
            DistinctUntilChangedObservable.prototype.subscribeCore = function (
              o
            ) {
              return this.source.subscribe(
                new DistinctUntilChangedObserver(o, this.keyFn, this.comparer)
              );
            };
          ...
          observableProto["do"] =
            observableProto.tap =
            observableProto.doAction =
              function (observerOrOnNext, onError, onCompleted) {
                return new TapObservable(
                  this,
                  observerOrOnNext,
                  onError,
                  onCompleted
          ...
          observableProto.doOnNext = observableProto.tapOnNext = function (
            onNext,
            thisArg
          ) {
            return this.tap(
          ...
          observableProto.doOnError = observableProto.tapOnError = function (
            onError,
            thisArg
          ) {
            return this.tap(
          ...
          observableProto.doOnCompleted = observableProto.tapOnCompleted =
            function (onCompleted, thisArg) {
              return this.tap(
                noop,
                null,
                typeof thisArg !== "undefined"
            ...
            RetryWhenObservable.prototype.subscribeCore = function (o) {
              ...
              var cancelable = currentThreadScheduler.scheduleRecursive(
                ...
                function (_, recurse) {
                  ...
                  var inner = new SingleAssignmentDisposable();
                  subscription.setDisposable(
                    new BinaryDisposable(inner, outer)
                  );
                  outer.setDisposable(
          ...
          var ScanObserver = (function (__super__) {
            ...
            ScanObserver.prototype.next = function (x) {
              ...
              if (this._ha) {
                ...
                this._a = this._hs
                  ? tryCatch(this._fn)(this._s, x, this._i, this._p)
                  : x;
                this._ha = true;
              }
              if (this._a === errorObj) {
          ...
          observableProto.startWith = function () {
            ...
            for (
              var args = [], i = start, len = arguments.length;
              i < len;
              i++
            ) {
              args.push(arguments[i]);
          ...
          observableProto.flatMapConcat = observableProto.concatMap = function (
            selector,
            resultSelector,
            thisArg
          ) {
          ...
          var MapObservable = (function (__super__) {
            ...
            MapObservable.prototype.internalMap = function (selector, thisArg) {
              return new MapObservable(
                this.source,
                innerMap(selector, this),
                thisArg
              );
            };
            MapObservable.prototype.subscribeCore = function (o) {
              return this.source.subscribe(
                new InnerObserver(o, this.selector, this)
              );
            };
            inherits(InnerObserver, AbstractObserver);
          ...
          observableProto.map = observableProto.select = function (
            selector,
            thisArg
          ) {
            var selectorFn =
          ...
          observableProto.flatMap = observableProto.selectMany = function (
            selector,
            resultSelector,
            thisArg
          ) {
          ...
          Rx.Observable.prototype.flatMapLatest = function (
            selector,
            resultSelector,
            thisArg
          ) {
          ...
          var FilterObservable = (function (__super__) {
            ...
            FilterObservable.prototype.subscribeCore = function (o) {
              return this.source.subscribe(
                new InnerObserver(o, this.predicate, this)
              );
            };
            ...
            FilterObservable.prototype.internalFilter = function (
              predicate,
              thisArg
            ) {
              return new FilterObservable(
                this.source,
                innerPredicate(predicate, this),
                thisArg
              );
            };
            inherits(InnerObserver, AbstractObserver);
            ...
            InnerObserver.prototype.next = function (x) {
              var shouldYield = tryCatch(this.predicate)(
                x,
                this.i++,
                this.source
              );
          ...
          function isNodeList(el) {
            if (root.StaticNodeList) {
              return (
                el instanceof root.StaticNodeList || el instanceof root.NodeList
              );
            } else {
          ...
          function createEventListener(el, eventName, handler) {
            ...
            if (isNodeList(el) || elemToString === "[object HTMLCollection]") {
              for (var i = 0, len = el.length; i < len; i++) {
                disposables.add(
                  createEventListener(el.item(i), eventName, handler)
                );
              }
            } else if (el) {
          ...
          Observable.fromEvent = function (element, eventName, selector) {
            ...
            return new EventObservable(element, eventName, selector)
              .publish()
              .refCount();
          };
          ...
          var fromEventPattern = (Observable.fromEventPattern = function (
            addHandler,
            removeHandler,
            selector
          ) {
            return new EventPatternObservable(
              addHandler,
              removeHandler,
              selector
            )
          ...
          var observableFromPromise = (Observable.fromPromise = function (
            promise,
            scheduler
          ) {
          ...
          observableProto.toPromise = function (promiseCtor) {
            ...
            if (!promiseCtor) {
              throw new NotSupportedError(
                "Promise type not provided nor in Rx.config.Promise"
              );
            }
            var source = this;
          ...
          var MulticastObservable = (function (__super__) {
            ...
            MulticastObservable.prototype.subscribeCore = function (o) {
              ...
              return new BinaryDisposable(
                this._fn2(connectable).subscribe(o),
                connectable.connect()
              );
            };
            return MulticastObservable;
          })(ObservableBase);
          observableProto.multicast = function (
            subjectOrSubjectSelector,
            selector
          ) {
            return isFunction(subjectOrSubjectSelector)
              ? new MulticastObservable(
                  this,
                  subjectOrSubjectSelector,
                  selector
                )
          ...
          observableProto.publishValue = function (
          ...
          observableProto.replay = function (
            selector,
            bufferSize,
            windowSize,
            scheduler
          ...
          observableProto.shareReplay = function (
            bufferSize,
            windowSize,
            scheduler
          ) {
          ...
          var RefCountObservable = (function (__super__) {
            ...
            RefCountDisposable.prototype.dispose = function () {
              if (!this.isDisposed) {
                ...
                this._s.dispose();
                --this._p._count === 0 &&
                  this._p._connectableSubscription.dispose();
              }
            };
            return RefCountObservable;
          })(ObservableBase);
          var ConnectableObservable = (Rx.ConnectableObservable = (function (
            __super__
          ) {
          ...
          function observableTimerDateAndPeriod(dueTime, period, scheduler) {
            return new AnonymousObservable(function (observer) {
              ...
              return scheduler.scheduleRecursiveFuture(
                0,
                d,
                function (count, self) {
                  if (p > 0) {
          ...
          function observableTimerTimeSpanAndPeriod(
            dueTime,
            period,
            scheduler
          ) {
            return dueTime === period
              ...
              : observableDefer(function () {
                  return observableTimerDateAndPeriod(
                    new Date(scheduler.now() + dueTime),
                    period,
                    scheduler
                  );
                });
          }
          var observableinterval = (Observable.interval = function (
            period,
            scheduler
          ) {
            return observableTimerTimeSpanAndPeriod(
              period,
              period,
              isScheduler(scheduler) ? scheduler : defaultScheduler
            );
          });
          var observableTimer = (Observable.timer = function (
            dueTime,
            periodOrScheduler,
            scheduler
          ) {
            ...
            isScheduler(scheduler) || (scheduler = defaultScheduler);
            if (
              periodOrScheduler != null &&
              typeof periodOrScheduler === "number"
            ) {
            ...
            if (
              (dueTime instanceof Date || typeof dueTime === "number") &&
              period === undefined
            ) {
                ...
                .subscribe(function (notification) {
                  ...
                  if (shouldRun) {
                    if (exception !== null) {
                      ...
                      d.setDisposable(
                        scheduler.scheduleRecursiveFuture(
                          null,
                          dueTime,
                          function (_, self) {
                            ...
                            if (q.length > 0) {
                              shouldRecurse = true;
                              recurseDueTime = Math.max(
                                0,
                                q[0].timestamp - scheduler.now()
                              );
                            } else {
                              active = false;
                            }
          ...
          function observableDelayAbsolute(source, dueTime, scheduler) {
            return observableDefer(function () {
              return observableDelayRelative(
                source,
          ...
          observableProto.delay = function () {
            ...
            if (typeof firstArg === "number" || firstArg instanceof Date) {
              ...
              Observable.isObservable(firstArg) ||
              isFunction(firstArg)
            ) {
          ...
          var DebounceObservable = (function (__super__) {
            ...
            DebounceObservable.prototype.subscribeCore = function (o) {
              ...
              return new BinaryDisposable(
                this.source.subscribe(
                  new DebounceObserver(o, this._dt, this._s, cancelable)
                ),
                cancelable
              );
            };
          ...
          var DebounceObserver = (function (__super__) {
            ...
            function scheduleFuture(s, state) {
              state.self._hv &&
                state.self._id === state.currentId &&
                state.self._o.onNext(state.x);
            ...
            DebounceObserver.prototype.next = function (x) {
              ...
              d.setDisposable(
                this._scheduler.scheduleFuture(
                  this,
                  this._d,
                  function (_, self) {
            ...
            return new AnonymousObservable(function (o) {
              ...
              var subscription = source.subscribe(
                function (x) {
                  ...
                  isPromise(throttle) &&
                    (throttle = observableFromPromise(throttle));
                  hasValue = true;
                  value = x;
                  id++;
                  var currentid = id,
          ...
          var SampleObservable = (function (__super__) {
            ...
            SampleObservable.prototype.subscribeCore = function (o) {
              ...
              state.sourceSubscription.setDisposable(
                this.source.subscribe(new SampleSourceObserver(state))
              );
              return new BinaryDisposable(
          ...
          observableProto.sample = function (intervalOrSampler, scheduler) {
            ...
            return typeof intervalOrSampler === "number"
              ? new SampleObservable(
                  this,
                  observableinterval(intervalOrSampler, scheduler)
                )
          ...
          function timeout(source, dueTime, other, scheduler) {
            ...
            return new AnonymousObservable(function (o) {
              ...
              function createTimer() {
                var myId = id;
                timer.setDisposable(
                  scheduler.scheduleFuture(null, dueTime, function () {
                    switched = id === myId;
                    if (switched) {
                      isPromise(other) &&
                        (other = observableFromPromise(other));
                      subscription.setDisposable(other.subscribe(o));
                    }
                  })
                );
          ...
          observableProto.throttle = function (windowDuration, scheduler) {
            ...
            if (duration <= 0) {
              throw new RangeError(
                "windowDuration cannot be less or equal zero."
              );
            }
            var source = this;
            return new AnonymousObservable(function (o) {
          ...
          var PausableBufferedObservable = (function (__super__) {
            ...
            PausableBufferedObservable.prototype._subscribe = function (o) {
              ...
              var subscription = combineLatestSource(
                ...
                function (results) {
                  if (
                    previousShouldFire !== undefined &&
                    results.shouldFire !== previousShouldFire
                  ) {
          ...
          var ControlledObservable = (function (__super__) {
            ...
            ControlledObservable.prototype.request = function (numberOfItems) {
              return this.subject.request(
                numberOfItems == null ? -1 : numberOfItems
              );
            };
            ...
            addProperties(ControlledSubject.prototype, Observer, {
              ...
              onNext: function (value) {
                if (this.requestedCount <= 0) {
                  this.enableQueue &&
                    this.queue.push(Notification.createOnNext(value));
                } else {
          ...
          var TransduceObserver = (function (__super__) {
            ...
            TransduceObserver.prototype.next = function (x) {
              var res = tryCatch(this._xform["@@transducer/step"]).call(
                this._xform,
                this._o,
                x
              );
          ...
          var AnonymousObservable = (Rx.AnonymousObservable = (function (
            __super__
          ) {
          ...
          var AutoDetachObserver = (function (__super__) {
            ...
            AutoDetachObserverPrototype.error = function (err) {
              var result = tryCatch(this.observer.onError).call(
                this.observer,
                err
              );
              this.dispose();
            ...
            AutoDetachObserverPrototype.completed = function () {
              var result = tryCatch(this.observer.onCompleted).call(
                this.observer
              );
              this.dispose();
              result === errorObj && thrower(result.e);
            ...
            addProperties(Subject.prototype, Observer.prototype, {
              ...
              onCompleted: function () {
                ...
                if (!this.isStopped) {
                  this.isStopped = true;
                  for (
                    var i = 0, os = cloneArray(this.observers), len = os.length;
                    i < len;
                    i++
                  ) {
                    os[i].onCompleted();
          ...
          var ReplaySubject = (Rx.ReplaySubject = (function (__super__) {
            ...
            function createRemovableDisposable(subject, observer) {
              return disposableCreate(function () {
                observer.dispose();
                !subject.isDisposed &&
                  subject.observers.splice(
                    subject.observers.indexOf(observer),
                    1
                  );
              });
            }
            ...
            function ReplaySubject(bufferSize, windowSize, scheduler) {
              this.bufferSize =
                bufferSize == null ? maxSafeInteger : bufferSize;
              this.windowSize =
                windowSize == null ? maxSafeInteger : windowSize;
              this.scheduler = scheduler || currentThreadScheduler;
              this.q = [];
              this.observers = [];
              this.isStopped = false;
            ...
            addProperties(ReplaySubject.prototype, Observer.prototype, {
              ...
              _trim: function (now) {
                ...
                while (
                  this.q.length > 0 &&
                  now - this.q[0].interval > this.windowSize
                ) {
                  this.q.shift();
                }
              },
        ...
        exports,
        __webpack_require__(134)(module),
