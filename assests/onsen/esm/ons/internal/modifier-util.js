  ...
  _createClass(ModifierUtil, null, [
    ...
    },
    {
      ...
      value: function applyDiffToElement(diff, element, scheme) {
        Object.keys(scheme).forEach(function (selector) {
          var targetElements =
            !selector || _util2.default.match(element, selector)
              ? [element]
              : Array.prototype.filter.call(
                  element.querySelectorAll(selector),
                  function (targetElement) {
                    return !_util2.default.findParent(
                      targetElement,
                      element.tagName,
                      function (parent) {
          ...
          for (var i = 0; i < targetElements.length; i++) {
            ModifierUtil.applyDiffToClassList(
              diff,
    ...
    },
    {
      ...
      value: function onModifierChanged(last, current, element, scheme) {
        ModifierUtil.applyDiffToElement(
          ModifierUtil.diff(last, current),
          element,
          scheme
        );
    ...
    },
    {
      ...
      value: function refresh(element, scheme) {
        ModifierUtil.applyDiffToElement(
          ModifierUtil.diff("", element.getAttribute("modifier") || ""),
          element,
          scheme
        );
      },
